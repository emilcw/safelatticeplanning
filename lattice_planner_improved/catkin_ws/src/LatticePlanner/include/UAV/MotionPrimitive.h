...
namespace UAV {
  ...
  class MotionPrimitive {
    ...
    public:
      int ID;                                   // Unique idenfier for each Motion Primtive
      int group;                                // Motion primitive group
      string name;                              // Unique name of the Motion Primitive
      ...
      PrimitiveType type;                       // If is primary (high-resolution) or secondary (low-resolution)
      FT cost;                                  // Distance travelled from SearchState from to SearchState to when executing a certain MP
      FT duration;                              // The time it takes to execute the MP between two SearchStates
