...
Low-level MPC controller for DJI Matice 100 using ROS. The core of the project is a copy of the ETH zurich repository mav_control_rw that can be found here: https://travis-ci.org/ethz-asl/mav_control_rw.
...
Cite
------
If you use any of these controllers within your research, please cite one of the following references with this work is based up on
...
[TODO: OLD]Published and subscribed topics
------

The nonlinear MPC controllers publish and subscribe to the following topics:
