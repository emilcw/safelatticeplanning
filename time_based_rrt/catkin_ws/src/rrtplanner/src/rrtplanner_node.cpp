    ...
    if(rrt.has_valid_state())
    {
      ...
      if(!rrt.plan_.poses.empty())
      {
        ...
        */
        ...
        {
          ROS_INFO_STREAM("Temporal RRT* -- Flying Iteration: " << i << " -- ");
          ...
          //timeToReach = (distance_left / rrt.getDroneLinearVelocity());
          timeToReach = time_steps.back();
          ...
          //elapsed_fly = ros::Time::now() - start_fly;
          //ROS_INFO_STREAM("FLY-TIME: " << elapsed_fly);
          //total_time += elapsed_fly.toSec();
          //double average_fly_time = (total_time) / (i+1);
          //ROS_INFO_STREAM("TOTAL-FLY-TIME: " << total_time);
          //ROS_INFO_STREAM("AVERAGE-FLY-TIME: " << average_fly_time);
        }
