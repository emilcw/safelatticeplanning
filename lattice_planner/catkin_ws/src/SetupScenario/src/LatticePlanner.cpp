...
bool LatticePlanner::do_planning_cycle(SearchState from, 
  ...
  LP_DEBUG(LP::INFO, "Planning from (" << &this->rootState << "): \n");
  LP_DEBUG(LP::INFO, this->rootState.state << std::endl);
  LP_DEBUG(LP::INFO, "Planning to (" << &this->goalState << "): \n");
  LP_DEBUG(LP::INFO, this->goalState.state << std::endl);
